...
public class CardApiApplication {
	...
	CommandLineRunner run(UserService userService){
		...
		return args -> {
			...
			userService.saveRole(new Role(2L,"ROLE_SUPER_ADMIN"));
			userService.saveRole(new Role(4L,"ROLE_ADMIN_MANAGER"));


			userService.saveUser(new User(1L,"Nelly Nel","nelly@gmail.com","1234",new ArrayList<>()));
			userService.saveUser(new User(2L,"patrick kabz","patrick@gmail.com","1234",new ArrayList<>()));
			userService.saveUser(new User(3L,"Nesh ","nesh@gmail.com","1234",new ArrayList<>()));
